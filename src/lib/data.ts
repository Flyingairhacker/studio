...
export const localProjects: Project[] = [
  {
    ...
    tags: ["Flutter", "Firebase", "IoT", "Data Visualization"],
    systemType: "Web",
    repoUrl: "#",
    liveUrl: "#",
  ...
  },
  {
    ...
    tags: ["Flutter", "Bluetooth LE", "Mobile", "UI/UX"],
    systemType: "Mobile",
    repoUrl: "#",
  ...
  },
  {
    ...
    tags: ["Python", "TensorFlow Lite", "MQTT", "IoT"],
    systemType: "IoT",
    liveUrl: "#",
  ...
  },
  {
    ...
    tags: ["Flutter Desktop", "Dart", "Serial Port", "Networking"],
    systemType: "Desktop",
    repoUrl: "#",
    liveUrl: "#",
